...
const valorTotalFinal = async ({ periodo, periodoAnoMes, taxaJuros, taxaJurosAnoMes, valorInicial, valorMensal }) => {
    ...
    for (let mes = 0; mes <= numMeses; mes++) {
        if (mes > 0) {
            ...
            tabela.push({
                ...
                totalInvestido: Number( (valorInicial + valorMensal * mes).toFixed(2)), // Atualiza o total investido com aportes mensais
